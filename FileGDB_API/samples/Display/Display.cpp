...
int LoadCities(double xMin, double yMin, double xMax, double yMax, vector<city>& results)
{
...
void DrawCity(double xCoord, double yCoord, int popCategory, string name)
{
